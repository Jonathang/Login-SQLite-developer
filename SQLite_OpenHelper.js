public class SQLite_OpenHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_USER_NAME = "user_nombre";
    private static final String COLUMN_USER_EMAIL = "user_correo";
    ...
    public void addUser(Model user) {
        ...
        values.put(COLUMN_USER_EMAIL, user.getCorreo());
    ...
    public List<Model> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setCorreo(cursor.getString(cursor.getColumnIndex(COLUMN_USER_EMAIL)));
     ...
     * @param user
     */
    public void deleteUser(Model user) {
        SQLiteDatabase db = this.getWritableDatabase();
